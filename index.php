...
<body id="page-top">
        ...
        <div class="container h-100">
            <div class="row h-100 align-items-center justify-content-center text-center">
                <div class="col-lg-10 align-self-end">
                    <h1 class="text-uppercase text-white font-weight-bold">CRS-Rescue
                    </h1>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 text-center">
                    <div class="mt-5">
                        ...
                        <p class="text-muted mb-0">
                            A community that is directly involved in helping and providing good service.
                        </p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 text-center">
                    <div class="mt-5">
                        ...
                        <p class="text-muted mb-0">
                            ...
                            by strengthening leadership, cohesiveness, the latest innovations and empowering individuals
                            as volunteers.
                        </p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 text-center">
                    <div class="mt-5">
                        ...
                        <p class="text-muted mb-0">
                            Gather people who want to become part of volunteers who can be accessed through the CRS
                            Application, which we call CRS-Rescue.
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-8 text-center text-white">
                    ...
                    <hr class="divider my-4" />
                    <p class="mb-5">Ready to start working as volunteer with us? Give us a call or send us an
            ...
            <div class="row">
                <div class="col-lg-4 ml-auto text-center mb-5 mb-lg-0">
                    ...
                    <div class="text-white">+60 (111) 123-4567</div>
                </div>
                <div class="col-lg-4 mr-auto text-center">
                    <i class="fas fa-envelope fa-3x mb-3"></i>
                    <!-- Make sure to change the email address in BOTH the anchor text and the link target below!-->
                    <a class="d-block" href="mailto:crs@crssite.com">crs@crssite.com</a>
                </div>
            </div>
        </div>
    </section>
    ...
    <footer class="bg-light py-5">
        <div class="container">
            <div class="small text-center text-muted">Copyright © 2021 - CRS</div>
        </div>
    </footer>
    <!-- Bootstrap core JS-->
