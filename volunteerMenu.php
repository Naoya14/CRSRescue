  ...
  <div class="d-flex" id="wrapper">
    ...
    <div id="page-content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <br>
        <p>Currently there are many natural disasters that occur in almost all countries. This problem has often been
          faced by various countries and the impact of this natural disaster is that many parties or people are
          disadvantaged.</p>

        <p>In this case, the motivation for this project is to provide assistance to affected communities
          and to gather people who want to be part of volunteers through an application called CRS Rescue.</p>
