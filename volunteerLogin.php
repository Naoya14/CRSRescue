...
<body class="crs">
  ...
  <section>
    <div class="container margin-top">
      ...
      <form method="post" class="form" name="volunteerLoginForm" action="volunteer_check.php">
        ...
        <input type="button" value="Volunteer Login" class="btn btn-danger mt-4 mb-3"></input>
      </form>
